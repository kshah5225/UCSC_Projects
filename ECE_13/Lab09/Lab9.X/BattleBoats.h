...
typedef enum {
    BB_EVENT_NO_EVENT, //0
    BB_EVENT_START_BUTTON, //1//kunal cant figure out what this is for
    BB_EVENT_RESET_BUTTON, //2//kunal cant figure out what this is for
    BB_EVENT_CHA_RECEIVED, //3
    BB_EVENT_ACC_RECEIVED, //4
    BB_EVENT_REV_RECEIVED, //5
    BB_EVENT_SHO_RECEIVED, //6
    BB_EVENT_RES_RECEIVED, //7//kunal cant figure out what this is for
    BB_EVENT_MESSAGE_SENT, //8//kunal cant figure out what this is for
    BB_EVENT_ERROR, //9

    //the following events are only used for human agents:
    BB_EVENT_SOUTH_BUTTON, //10//kunal cant figure out what this is for
    BB_EVENT_EAST_BUTTON, //11//kunal cant figure out what this is for
